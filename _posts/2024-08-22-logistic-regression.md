...
However, due to function dependency (l depends on y, then y depends on z and finally z depends on w), we need to use product rule of derivatives as follows,
