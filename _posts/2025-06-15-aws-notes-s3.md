...
- We can enable versioning of files so that changes are tracked
    ...
    - Deleting a key will create a new version, add a Delete Marker to it, make it as current version and mark other versions as non-current version
    - Deleting a specific version of a key will delete it permanently
