...
$$ Softmax(z) = \frac {e^{z_j}}{\sum_{j=1}^C e^{z_j}} \frac {e^{-z_max}}{e^{-z_max}} $$

$$ Softmax(z) = \frac {e^{z_j-z_max}}{\sum_{j=1}^C e^{z_j-z_max}}$$
...
$$ p_i = \frac {e^{z_i-z_max}}{\sum_{j=1}^C e^{z_j-z_max}}$$

- Taking `log` both sides, we get

$$ \log p_i = \log \frac {e^{z_i-z_max}}{\sum_{j=1}^C e^{z_j-z_max}} $$

$$ \log p_i = \log {e^{z_i-z_max}} - \log {\sum_{j=1}^C e^{z_j-z_max}} $$

$$ \log p_i = z_i-z_max - \log {\sum_{j=1}^C e^{z_j-z_max}} $$
