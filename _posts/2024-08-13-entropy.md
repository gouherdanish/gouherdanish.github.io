...
$$ S(X) = -(1 \over 8)(log(1 \over 8)) -(3 \over 8)(log(3 \over 8)) -(3 \over 8)(log(3 \over 8)) -(1 \over 8)(log(1 \over 8)) $$

$$ S(X) = -(2.07944154 + 3*0.98082925 + 3*0.98082925 + 2.07944154) \over 8 $$

$$ S(X) = 1.2554823251787535 $$
